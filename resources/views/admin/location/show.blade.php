    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('admin.location.dataTables') }}",
          },
          columns: [
            {data: null},
            // {data: 'kode'},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("admin.location.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("admin.location.store", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("admin.location.update", ":id") }}';
