    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {{-- <div class="form-group">
          ...
          <input type="text" name="kode" class="form-control" id="form-kode" placeholder="Kode..." required>
          <div class="invalid-feedback">Kode wajib diisi.</div>
        </div> --}}
        <div class="form-group">
          <label for="title">Nama Lokasi</label>
          <input type="text" name="name" class="form-control" id="form-name" placeholder="Nama Lokasi..." required>
