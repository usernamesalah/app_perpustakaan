<x-app-layout>
  ...
  <x-slot name="title">PENGARANG</x-slot>
    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">Pengarang</div>
        </div>
      </div>
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('admin.author.dataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'name'},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("admin.author.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("admin.author.store", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("admin.author.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("admin.author.destroy", ":id") }}';
