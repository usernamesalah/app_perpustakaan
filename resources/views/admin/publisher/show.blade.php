<x-app-layout>
  ...
  <x-slot name="title">PENERBIT</x-slot>
    ...
    <script>
      $(document).ready(function () {
        ...
        var dataTable = $('#dataTable').DataTable({
          processing: true,
          ajax: {
              url: "{{ route('admin.publisher.dataTables') }}",
          },
          columns: [
            {data: null},
            {data: 'name'},
          ...
          columnDefs : [
            ...
            },
            {
              ...
              render: function ( data, type, row ) {
                var url = '{{ route("admin.publisher.edit", ":id") }}';
        ...
        $('#btn-create').click(function () {
          var url = '{{ route("admin.publisher.store", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("admin.publisher.update", ":id") }}';
        ...
        $('#dataTable tbody').on( 'click', '.btn-delete', function () {
          var id = $(this).data('id');
          var url = '{{ route("admin.publisher.destroy", ":id") }}';
